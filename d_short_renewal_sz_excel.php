...
$sql="SELECT * FROM installment_master_sz_short_premium_renewal WHERE is_deleted=1 ".$where." ORDER BY id DESC";
 //echo $sql;
// exit;
...
$numTransaction = mysql_num_rows($selTransaction);
	...
	header("Content-Disposition: attachment; filename=short_renewal_sz".'_'.date('m-d-Y_H:i').".xls");
