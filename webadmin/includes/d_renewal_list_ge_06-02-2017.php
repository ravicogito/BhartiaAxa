  ...
  <tbody>
    <tr> 
      ...
      <td colspan="25" align="right">
        <a title=" Export to Excel " href="<?=URL?>d_renewal_ge_excel.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
    ...
    <tr class="TDHEAD"> 
      <td colspan="25">Deleted Renewal Listing (GE)</td>
    </tr>
    <!--
	<tr>
