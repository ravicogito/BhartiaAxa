...
{	
	...
	mysql_query("UPDATE temporary_installment_master SET is_deleted=1 WHERE id=".$transaction_id);
...
$Query = "select count(id) as CNT from temporary_installment_master  ".$where;
#echo $Query;
...
$Query = "SELECT * FROM temporary_installment_master ".$where.$OrderBY.$Limit;
...
//$selTransaction = mysql_query("SELECT id, branch_id, customer_id, deposit_date, comitted_amount, amount, tenure, transaction_charges, first_name, last_name, phone, email FROM temporary_installment_master WHERE is_deleted=0 ORDER BY id DESC");
  ...
  <tbody>
    <tr> 
      ...
      <td colspan="25" align="right">
        <a title=" Export to Excel " href="<?=URL?>temporary_transaction_excel.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
...
?>
	<tr> 
	  ...
	  <td width="8%" align="center" valign="top" ><?php echo (intval($rs[$i]['pis_id']) != 0 ? 'Yes' : 'No'); ?></td>
			...
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_temporary_app_no_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php } ?>			
			</td>
			...
			<?php if($_SESSION[ROLE_ID] == '1'){ ?>
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_temporary_serial_no_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php } ?>			
			</td>
			...
			<br />
			<?php if($_SESSION[ROLE_ID] == '1'){ ?>
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_temporary_branch_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php } ?>		

			</td>
			<td width="8%" align="center" valign="top" ><?php echo $plan; ?>
			<br />
			<?php if($_SESSION[ROLE_ID] == '1'){ ?>
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_temporary_plan_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php } ?></td>
			...
			<br />
			<?php if($_SESSION[ROLE_ID] == '1'){ ?>
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_temporaty_app_name_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php } ?>			
			</td>
			...
			<br />
			<?php if($_SESSION[ROLE_ID] == '1'){ ?>
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_temporary_term_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php } ?>
			</td>
			<td width="8%" align="center" valign="top" ><?php echo $rs[$i]['amount']; ?></td>
			...
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_temporary_agent_name_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php }} ?>
			</td>
			
			<td width="8%" align="center" valign="top" ><?php echo $rs[$i]['agent_code']; ?>
			<br />
			<?php if($_SESSION[ROLE_ID] == '1'){if($rs[$i]['agent_code'] != ""){ ?>
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_temporary_agent_code_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php }} ?>
			</td>
			...
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_temporary_dd_number_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php }} ?>
			...
			<br />
			<?php if($_SESSION[ROLE_ID] == '1'){if($rs[$i]['dd_number'] != ""){ ?>
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_temporary_dd_date_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php }} ?>
			</td>
			...
			<br />
			<?php if($_SESSION[ROLE_ID] == '1'){if($rs[$i]['dd_number'] != ""){ ?>
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_temporary_dd_bank_name_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php }} ?></td>
			...
			<br />
			<?php if($_SESSION[ROLE_ID] == '1'){ ?>
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_trmporary_sum_assured_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php } ?></td>
			...
			<td width="8%" align="center" valign="top" > 
			<?php if($_SESSION[ROLE_ID] == '1'){?>
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_trmporary_enrty_edit.php?id=<?php echo base64_encode($mysql_id); ?>')">Edit
			<?php }?>
			</td>
			...
			//} ?></td>	 -->
			<td width="8%" align="center" valign="top" >			
				<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_temporary.php?id=<?php echo base64_encode($mysql_id); ?>')">Generate</a>		
			</td>
			<?php
