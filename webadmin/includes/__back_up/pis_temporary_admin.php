  ...
  <tbody>
    <tr> 
      ...
      <td colspan="20" align="right">
        <a title=" Export to Excel " href="<?=URL?>pis_excel.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
		<?php
			}	
	...
	<tr> 
      <td colspan="20" align="left">
				<table>
				<tr>
						<td colspan="3" align="center"><strong>Branch PIS (SICL NEW)<br/><br/></strong></td>
					...
					<tr>
						...
						<td width="150">
							...
							<?php 
								$selBranch = mysql_query("SELECT branch_name, id FROM admin WHERE role_id=4 AND branch_user_id=0 ORDER BY branch_name ASC");
...
?>
	...
	<tr> 			
			...
			<td width="8%" align="center" valign="top" ><a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_pis_admin.php?id=<?php echo base64_encode($mysql_id); ?>')">View</a></td>
