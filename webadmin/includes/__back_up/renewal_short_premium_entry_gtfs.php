...
//	$invoice_id = base64_decode($_GET['id']);
	...
	if(isset($_POST['short_premium_payment_mode']) && $_POST['short_premium_payment_mode'] != '')
	{
		...
		$insert_short_installment = "INSERT INTO renewal_short_premium_gtfs SET
				...
				$updt_transaction_id = "UPDATE renewal_short_premium_gtfs SET transaction_id = '".$transaction_id."' WHERE id =".$branch_transaction;
				mysql_query($updt_transaction_id);

				header("location: ".URL.'webadmin/index.php?p=renewal_short_list_branch_gtfs');
