...
$Query = "select count(id) as CNT from temporary_pis_master ".$where;
#echo $Query;
...
$Query = "SELECT * FROM temporary_pis_master ".$where.$OrderBY.$Limit;
...
//$selTransaction = mysql_query("SELECT id, branch_id, customer_id, deposit_date, comitted_amount, amount, tenure, transaction_charges, first_name, last_name, phone, email FROM temporary_temporary_installment_master WHERE is_deleted=0 ORDER BY id DESC");
  ...
  <tbody>
    <tr> 
      ...
      <td colspan="20" align="right">
        <a title=" Export to Excel " href="<?=URL?>pis_temporary_excel.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
		<?php
			}	
      ...
      <td colspan="20" align="left">
				...
				<tr>
					...
					<tr>
						...
						?>
							<input type="button" name="btnPis" value="Generate PIS" class="inplogin" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_temporary_pis.php?pisdate=<?php echo $_POST['from_date']?>&pismode=<?php echo $_POST['pis_mode']?>')">
						<?php
						}	
						?>
						</td>
...
?>
	...
	<tr> 			
			...
			<td width="8%" align="center" valign="top" ><a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_temporary_pis_admin.php?id=<?php echo base64_encode($mysql_id); ?>')">View</a></td>
