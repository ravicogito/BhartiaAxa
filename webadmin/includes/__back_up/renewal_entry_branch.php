...

{
...

	{
			...
			$branch_state = find_state_id_through_branch_id($branch_name);
				...
				$insert_installment = "INSERT INTO renewal_master SET 
				...
				$updt_transaction_id = "UPDATE renewal_master SET transaction_id = '".$transaction_id."' WHERE id =".$branch_transaction;
				...
				header("location: ".URL.'webadmin/index.php?p=renewal_list_branch');
...
<TABLE class="table_border" cellSpacing=2 cellPadding=5 width="100%" align=center border=0>
  ...
  <tbody>
    ...
    <tr class="TDHEAD"> 
      ...
      <td colspan="3">Renewal Entry (SICL)</td>
