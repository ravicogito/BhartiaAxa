  ...
  <tbody>
    <tr> 
      ...
      <td colspan="25" align="right">
        <a title=" Export to Excel " href="<?=URL?>direct_renewal_excel_admin.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
	...
	<tr> 
     <!-- <td width="8%" align="center" valign="top" ><?php echo (intval($rs[$i]['pis_id']) != 0 ? 'Yes' : 'No'); ?></td>
	  <td width="8%" align="center" valign="top" ><?php echo (intval($rs[$i]['is_duplicate']) != 0 ? 'Yes' : 'No'); ?></td>
			...
			<td width="8%" align="center" valign="top" > <a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_edit_direct_renewal.php?id=<?php echo base64_encode($mysql_id); ?>')">Edit</td>
		...
		<!--	<td width="8%" align="center" valign="top" > <a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_short_premium.php?id=<?php echo base64_encode($mysql_id); ?>')">Short Premium</td>-->
			...
			<td width="8%" align="center" valign="top" ><a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_cancel_direct_renewal.php?id=<?php echo base64_encode($mysql_id); ?>')">Cancel</a></td> 
