...
if(isset($branch_scan) && count($branch_scan) > 0)
{
	...
	$receivedUpdate = mysql_query("UPDATE temporary_installment_master SET branch_scan=1,  branch_scan_date='".$today."' WHERE id IN (".$receiveStr.") ");
}
  ...
  <tbody>
    ...
    <tr> 
      ...
      <td width="8%" align="center" valign="top" class="tbllogin">PIS Generated</td>
			...
			<td width="16%" align="center" valign="top" class="tbllogin">First Name</td>
...
?>
	...
	<td width="8%" align="center" valign="top" ><input type="checkbox" name="branch_scan[]" value="<?php echo $mysql_id; ?>" <?php echo ($rs[$i]['branch_scan'] == '1' ? 'checked disabled="disabled"' : '')?>></td>
      ...
      <td width="8%" align="center" valign="top" ><?php echo (intval($rs[$i]['pis_id']) != 0 ? 'Yes' : 'No'); ?></td>
			...
			<td width="8%" align="center" valign="top" >
			<?php echo $rs[$i]['transaction_id']; ?><br />
			...
			<td width="16%" align="center" valign="top" ><?php echo $rs[$i]['first_name']; ?></td>
			...
			<td width="8%" align="center" valign="top" > <a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_trmporary_enrty_edit.php?id=<?php echo base64_encode($mysql_id); ?>')">Edit</td>
