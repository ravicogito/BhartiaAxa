...
$Query = "select count(id) as CNT from pis_master ".$where;
  ...
  <tbody>
    ...
    <tr> 
      ...
      <td colspan="20" align="right">
        ...
        <a title=" Export to Excel " href="<?=URL?>d_pis_excel.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
...
<!--							<input type="button" name="btnPis" value="Generate PIS" class="inplogin" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_pis.php?pisfromdate=<?php echo $_POST['from_date']?>&pistodate=<?php echo $_POST['to_date']?>&pismode=<?php echo $_POST['pis_mode']?>')">-->
