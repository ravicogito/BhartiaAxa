...
$Query = "select count(id) as CNT from installment_master_short_premium ".$where;
//$Query;
...
$Query = "SELECT * FROM installment_master_short_premium ".$where.$OrderBY.$Limit;
  ...
  <tbody>
    <tr> 
      ...
      <td colspan="25" align="right">
        <a title=" Export to Excel " href="<?=URL?>d_fresh_sz_excel.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
    ...
    <tr class="TDHEAD"> 
      <td colspan="25">Deleted Short Premium Listing</td>
    </tr>
    <!--
	<tr>
