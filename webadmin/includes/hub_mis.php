  ...
  <tbody>
    <tr> 
      ...
      <td colspan="20" align="right">
        <a title=" Export to Excel " href="<?=URL?>mis_excel.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
		<?php
			}	
	...
	<tr> 
				...
				<table>
					...
					<tr>
						...
						<?php if(isset($_SESSION['hub_name']))
								{
								$branch_sql = "SELECT branch_name, id FROM admin WHERE branch_user_id=0 AND role_id in (4) ORDER BY branch_name ASC";
      ...
      <td colspan="20" align="right">
		...
		?>
    <tr class="TDHEAD"> 
      <td colspan="20">Transaction Listing</td>
    </tr>
		<!-- <tr>
