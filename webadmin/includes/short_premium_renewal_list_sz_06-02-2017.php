...
if(isset($_SESSION['hub_name_id']) && $_SESSION['hub_name_id'] != '') 
	...
	##### CODE FOR SEARCHING 
$Query = "select count(id) as CNT from installment_master_sz_short_premium_renewal  ".$where;
// $Query;
...
$Query = "SELECT * FROM installment_master_sz_short_premium_renewal ".$where.$OrderBY.$Limit;
//echo $Query;
#exit;
$objDB->setQuery($Query);
$rs = $objDB->select();
  ...
  <tbody>
    <tr> 
      ...
      <td colspan="25" align="right">
        <a title=" Export to Excel " href="<?=URL?>transaction_excel_short_renewal_sz.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
	<tr> 
...
?>
	<tr> 
			...
			<td width="8%" align="center" valign="top" > 
                            ...
                            <a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_edit_short_renewal_sz.php?id=<?php echo base64_encode($mysql_id); ?>')">Edit</a>
			...
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/short_renewal_sz_cancel.php?id=<?php echo base64_encode($mysql_id); ?>')">Cancel</a>
                        <?php } ?>
			</td>
			<?php } ?>
