...
$Query = "select count(id) as CNT from pis_master_sz_short_premium_renewal ".$where;
...
$Query = "SELECT * FROM pis_master_sz_short_premium_renewal ".$where.$OrderBY.$Limit;
  ...
  <tbody>
    ...
    <tr> 
      ...
      <td colspan="20" align="right">
        ...
        <a title=" Export to Excel " href="<?=URL?>d_pis_excel_short_renewal_sz.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
				...
				<tr>
					...
					<tr>
					  ...
					  <td colspan="3" align="center"><input type="submit" name="btnSubmit" value="Search" class="inplogin">
						...
						?>
						<input type="button" name="btnPis" value="Generate PIS" class="inplogin" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_pis_short_renewal_sz.php?pisfromdate=<?php echo $_POST['from_date']?>&pistodate=<?php echo $_POST['to_date']?>&pismode=<?php echo $_POST['pis_mode']?>')" />
						<?php
