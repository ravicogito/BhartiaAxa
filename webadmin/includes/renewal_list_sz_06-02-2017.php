  ...
  <tbody>
    <tr> 
      ...
      <td colspan="25" align="right">
        <a title=" Export to Excel " href="<?=URL?>transaction_excel_renewal_sz.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
	<tr> 
	...
	<tr> 
			...
			<?php if($_SESSION[ROLE_ID] == '1' || $_SESSION[ROLE_ID] == '4'){ 
                        ...
                        <td width="8%" align="center" valign="top" > 
                            ...
                            <a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_edit_renewal_sz.php?id=<?php echo base64_encode($mysql_id); ?>')">Edit</a>
