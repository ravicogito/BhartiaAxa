...
$Query = "select count(id) as CNT from pis_master_ge_renewal ".$where;
...
$Query = "SELECT * FROM pis_master_ge_renewal ".$where.$OrderBY.$Limit;
  ...
  <tbody>
    ...
    <tr> 
      ...
      <td colspan="20" align="right">
        ...
        <a title=" Export to Excel " href="<?=URL?>d_pis_excel_renewal_ge.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
				...
				<tr>
					...
					<tr>
						...
						?>
							...
							<input type="button" name="btnPis" value="Generate PIS" class="inplogin" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_pis_renewal_ge.php?pisfromdate=<?php echo $_POST['from_date']?>&pistodate=<?php echo $_POST['to_date']?>&pismode=<?php echo $_POST['pis_mode']?>')">
