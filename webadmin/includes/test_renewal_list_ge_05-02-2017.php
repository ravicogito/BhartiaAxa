  ...
  <tbody>
    <tr> 
      ...
      <td colspan="26" align="right">
        <a title=" Export to Excel " href="<?=URL?>test_transaction_excel_renewal_ge.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
	<tr> 
            ...
            ********************************************************************************************************-->
			...
			<?php if($_SESSION[ROLE_ID] == '1' || $_SESSION[ROLE_ID] == '4'){
                            ...
                            <td width="8%" align="center" valign="top" > 
                                ...
                                <a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/test_window_edit_renewal_ge.php?id=<?php echo base64_encode($mysql_id); ?>')">Edit</a>
