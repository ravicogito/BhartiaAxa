  ...
  <tbody>
    <tr> 
      ...
      <td colspan="25" align="right">
        <a title=" Export to Excel " href="<?=URL?>transaction_excel_short_renewal_ge.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
	<tr> 
...
?>
	<tr> 
			<td width="8%" align="center" valign="top" ><?php echo $pis_id; ?></td>	
			...
			<td width="8%" align="center" valign="top" > 
                            ...
                            <a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_edit_short_renewal_ge.php?id=<?php echo base64_encode($mysql_id); ?>')">Edit</a>
