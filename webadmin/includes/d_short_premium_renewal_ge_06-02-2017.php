...
$Query = "select count(id) as CNT from installment_master_ge_short_premium_renewal  ".$where;
// $Query;
...
$Query = "SELECT * FROM installment_master_ge_short_premium_renewal ".$where.$OrderBY.$Limit;
  ...
  <tbody>
    <tr> 
      ...
      <td colspan="25" align="right">
        <a title=" Export to Excel " href="<?=URL?>d_short_renewal_ge_excel.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
    ...
    <tr class="TDHEAD"> 
      <td colspan="25">Deleted Renewal Short Premium Listing (GE)</td>
    </tr>
    <!--
	<tr>
    ...
    <tr> 
			...
			<td width="8%" align="center" valign="top" class="tbllogin">Cancel Reason</td>
...
?>
	<tr> 
			...
			<td width="8%" align="center" valign="top" ><?php echo $rs[$i]['plan_name']; ?></td>
			<td width="8%" align="center" valign="top" ><?php echo date('d/m/Y', strtotime($rs[$i]['business_date'])); ?></td>			
                        <td width="16%" align="center" valign="top" ><?php echo find_business_type($rs[$i]['business_type']); ?></td>
			<td width="16%" align="center" valign="top" ><?php echo $rs[$i]['applicant_name']; ?></td>
			...
			<!--<td width="8%" align="center" valign="top" > <a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_edit_short_renewal_ge.php?id=<?php echo base64_encode($mysql_id); ?>')">Edit</td>-->

			<?php if($_SESSION[ROLE_ID] == '1'){ ?>
			<!--<td width="8%" align="center" valign="top" >
			
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/short_renewal_ge_cancel.php?id=<?php echo base64_encode($mysql_id); ?>')">Cancel</a>
			</td>-->
			<?php } ?>
