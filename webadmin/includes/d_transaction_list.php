  ...
  <tbody>
    <tr> 
      ...
      <td colspan="25" align="right">
        <a title=" Export to Excel " href="<?=URL?>d_transaction_excel.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
    ...
    <tr class="TDHEAD"> 
      <td colspan="25">Deleted Transaction Listing</td>
    </tr>
    <!--
	<tr>
...
?>
	<tr> 
			...
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/transaction_cancel.php?id=<?php //echo base64_encode($mysql_id); ?>')">Cancel</a>
			</td>-->
			<?php //} ?>
