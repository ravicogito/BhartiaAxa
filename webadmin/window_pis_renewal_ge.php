...
{
	mysql_query("INSERT INTO pis_master_ge_renewal SET 
								branch_id='".$branch_id."',
	...
	{
		$update_main_payment = "UPDATE installment_master_ge_renewal SET cash_pis_id='".$previousID."' WHERE id IN(".$_POST['idstr_main_payment'].")";
		mysql_query($update_main_payment);
	}
	else if($_SESSION['pis_mode']=='CHEQUE') 
	{
		$update_main_payment = "UPDATE installment_master_ge_renewal SET cheque_pis_id='".$previousID."' WHERE id IN(".$_POST['idstr_main_payment'].")";
		mysql_query($update_main_payment);
	}
	else if($_SESSION['pis_mode']=='DD') 
	{
		$update_main_payment = "UPDATE installment_master_ge_renewal SET draft_pis_id='".$previousID."' WHERE id IN(".$_POST['idstr_main_payment'].")";
		mysql_query($update_main_payment);
	}
	if($_POST['idstr_alt_payment'] != '')
	{
		$update_alt_payment = "UPDATE installment_master_ge_renewal SET alt_pis_id='".$previousID."' WHERE id IN(".$_POST['idstr_alt_payment'].")";
...
$Query = "SELECT * FROM  installment_master_ge_renewal ".$where.$OrderBY;
// echo $Query;
