...
{
	extract($_POST);
	mysql_query("UPDATE pis_master_ge_renewal SET cms_no='".$cms_no."', deposit_date='".date('Y-m-d', strtotime($deposit_date))."' WHERE id='".$previousID."'");
...
{
	$selOldRec = mysql_query("SELECT * FROM pis_master_ge_renewal WHERE id='".$previousID."'");
