...
if(isset($_GET['id']) && !empty($_GET['id']))
{
	...
	if(isset($_POST['submit']) && $_POST['submit'] != '')
	{
		...
		$update_installment = "UPDATE installment_master_short_premium SET ";
...
<?php
	...
	$selTransaction = mysql_query("SELECT * FROM installment_master_short_premium WHERE id='".$invoice_id."'");
