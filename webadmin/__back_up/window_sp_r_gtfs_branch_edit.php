...
$app_id = base64_decode($_GET['id']); 
	...
	if(isset($_POST['charge']) && !empty($_POST['charge']))
	{
		...
		$update_installment = "UPDATE renewal_short_premium_gtfs SET branch_id = '".$charge."' WHERE id = '".$app_id."'";
...
<?php
	...
	$selTransaction = "SELECT branch_id FROM renewal_short_premium_gtfs WHERE id='".$app_id."'";
