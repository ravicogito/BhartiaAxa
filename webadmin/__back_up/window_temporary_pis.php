...
{
	mysql_query("INSERT INTO temporary_pis_master SET 
	...
	if($_POST['idstr_main_payment'] != '')
	{
		$update_main_payment = "UPDATE temporary_installment_master SET pis_id='".$previousID."' WHERE id IN(".$_POST['idstr_main_payment'].")";
	...
	{
		$update_alt_payment = "UPDATE temporary_installment_master SET alt_pis_id='".$previousID."' WHERE id IN(".$_POST['idstr_alt_payment'].")";
