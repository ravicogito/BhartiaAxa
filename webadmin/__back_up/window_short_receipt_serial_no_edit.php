...
$app_id = base64_decode($_GET['id']); 
	...
	if(isset($_POST['charge']) && !empty($_POST['charge']))
	{
		...
		$update_folio = "UPDATE insurance_short_premium  SET receipt_number = '".$charge."' WHERE id = '".$app_id."'";		//echo $update_folio;
		//exit;
...
<?php
	...
	$selTransaction = "SELECT receipt_number FROM insurance_short_premium WHERE id='".$app_id."'";
