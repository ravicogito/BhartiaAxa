	...
	if($numTransaction > 0)
		{
			...
			$service_tax = $getTransaction['service_tax'];
			$total_amount = $amount + $service_tax;
			...
			$receipt_serial_number = $getTransaction['serial_no'];
...
<script type="text/javascript" src="<?=URL?>js/site_scripts.js"></script>
 ...
 <form name="addForm" id="addForm" action="" method="post" onsubmit="return dochk()">
	...
	<tr> 
      <td class="tbllogin" valign="top" align="right">Service Tax</td>
      <td class="tbllogin" valign="top" align="center">:</td>
      <td valign="top" align="left"><?php echo $service_tax; ?></td>
    </tr>
	
	<tr> 
      <td class="tbllogin" valign="top" align="right">Total Amount</td>
      <td class="tbllogin" valign="top" align="center">:</td>
      <td valign="top" align="left"><?php echo $total_amount; ?></td>
    </tr>
