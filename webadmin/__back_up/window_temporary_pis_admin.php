...
{
	extract($_POST);
	mysql_query("UPDATE temporary_pis_master SET cms_no='".$cms_no."', deposit_date='".date('Y-m-d', strtotime($deposit_date))."' WHERE id='".$previousID."'");
...
{
	$selOldRec = mysql_query("SELECT * FROM temporary_pis_master WHERE id='".$previousID."'");
...
$Query = "SELECT * FROM temporary_installment_master ".$where.$OrderBY;
