...
{
	extract($_POST);
	mysql_query("UPDATE pis_master_ge_short_premium_renewal SET cms_no='".$cms_no."', deposit_date='".date('Y-m-d', strtotime($deposit_date))."' WHERE id='".$previousID."'");
...
{
	$selOldRec = mysql_query("SELECT * FROM pis_master_ge_short_premium_renewal WHERE id='".$previousID."'");
		 ...
		 <tr>
			<td colspan="3" align="center">
				<form method="post" action="" name="cms_frm" onsubmit="return pisCheck()">
					...
					<strong>GE SHORT RENEWAL PIS<br />
