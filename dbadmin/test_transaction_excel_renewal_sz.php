...
$sql="SELECT im.*, ad.branch_code FROM installment_master_sz_renewal as im JOIN admin as ad ON ad.id = im.branch_id WHERE is_deleted=0 ".$where." ORDER BY id DESC";
 //echo $sql;
// exit;
